...
The options for `useInfiniteQuery` are identical to the [`useQuery` hook](#v-use-query) with the addition of the following:
...
The returned properties for `useInfiniteQuery` are identical to the [`useQuery` hook](#v-use-query), with the addition of the following:
