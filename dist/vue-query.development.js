(function (global, factory) {
  ...
  function unwrapRefs(refs) {
    ...
    if (array || isPlainObject(refs)) {
      ...
      for (var i = 0; i < size; i++) {
        ...
        copy[key] = vue.isRef(refs[key]) ? refs[key].value : unwrapRefs(refs[key]);
      }
  ...
  var Query = /*#__PURE__*/function () {
    function Query(config) {
      ...
      this.innerState = vue.reactive(this.initialState);
      this.state = vue.readonly(this.innerState);
      this.scheduleGc();
    }
  ...
  var QueryObserver = /*#__PURE__*/function (_Subscribable) {
    ...
    _proto.getReadonlyResult = function getReadonlyResult() {
      return this.readonlyResult || (this.readonlyResult = vue.readonly(this.currentResult));
    };
    ...
    _proto.updateResult = function updateResult(willFetch) {
      ...
      if (this.currentResult) {
        ...
        this.currentResult = vue.reactive(result);
      }
    };
  ...
  var useQueryClient = function useQueryClient() {
    var queryClient = vue.inject(symbol, undefined);
  ...
  var QueryClientProvider = vue.defineComponent({
    name: 'QueryClientProvider',
    setup: function setup(props, _ref) {
      var slots = _ref.slots;
      var client = props.client;
      vue.provide(symbol, client);
  ...
  function useIsFetching(arg1, arg2) {
    ...
    var isFetching = vue.ref(queryClient.isFetching(filters));
    var unsubscribe;
    vue.onMounted(function () {
  ...
  function useMutation(arg1, arg2, arg3) {
    ...
    return vue.readonly(currentResult);
  }
  ...
  function useQueries(queries) {
    ...
    var currentResult = vue.reactive(observer.getCurrentResult());
...
//# sourceMappingURL=vue-query.development.js.map
